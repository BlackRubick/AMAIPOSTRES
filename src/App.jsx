...
export default function App(){
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <a className="whatsapp-fab" href={`https://wa.me/529613037073?text=${encodeURIComponent('Hola! Quiero ordenar')}`} target="_blank" rel="noreferrer" aria-label="Ordena ahora por WhatsApp">
